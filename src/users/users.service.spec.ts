...
//         { provide: getRepositoryToken(PrivacySettings), useFactory: mockPrivacyRepository },
//       ],
//     }).compile();
...
//         passwordHash: 'hashed',
//         privacySettings: { dataSharingLevel: 'balanced', communityVisibility: 'connections' },
//       };

//       const user = { id: '1', ...dto };
//       const savedUser = { ...user };
//       const savedPrivacy = { id: 'ps1', ...dto.privacySettings, trackingConsent: false, user: savedUser };
