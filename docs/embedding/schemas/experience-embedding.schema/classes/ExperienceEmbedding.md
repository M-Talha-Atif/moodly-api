...
[ai-moodler-backend](../../../../README.md) / [embedding/schemas/experience-embedding.schema](../README.md) / ExperienceEmbedding

# Class: ExperienceEmbedding

Defined in: [src/embedding/schemas/experience-embedding.schema.ts:6](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/experience-embedding.schema.ts#L6)
...
> **new ExperienceEmbedding**(`doc?`): `ExperienceEmbedding`
...
Defined in: [src/embedding/schemas/experience-embedding.schema.ts:11](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/experience-embedding.schema.ts#L11)
...
Defined in: [src/embedding/schemas/experience-embedding.schema.ts:8](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/experience-embedding.schema.ts#L8)
...
> **$assertPopulated**\<`Paths`\>(`path`, `values?`): `Omit`\<`ExperienceEmbedding`, keyof `Paths`\> & `Paths`
...
`Omit`\<`ExperienceEmbedding`, keyof `Paths`\> & `Paths`
...
> **depopulate**\<`Paths`\>(`path?`): `MergeType`\<`ExperienceEmbedding`, `Paths`\>
...
`MergeType`\<`ExperienceEmbedding`, `Paths`\>
...
> **getChanges**(): `UpdateQuery`\<`ExperienceEmbedding`\>
...
`UpdateQuery`\<`ExperienceEmbedding`\>
...
> **populate**\<`Paths`\>(`path`): `Promise`\<`MergeType`\<`ExperienceEmbedding`, `Paths`\>\>
...
`Promise`\<`MergeType`\<`ExperienceEmbedding`, `Paths`\>\>
...
> **populate**\<`Paths`\>(`path`, `select?`, `model?`, `match?`, `options?`): `Promise`\<`MergeType`\<`ExperienceEmbedding`, `Paths`\>\>
...
> **replaceOne**(`replacement?`, `options?`): `Query`\<`any`, `ExperienceEmbedding`\>
...
> **save**(`options?`): `Promise`\<`ExperienceEmbedding`\>
...
> **updateOne**(`update?`, `options?`): `Query`\<`any`, `ExperienceEmbedding`\>
...
`UpdateWithAggregationPipeline` | `UpdateQuery`\<`ExperienceEmbedding`\>
