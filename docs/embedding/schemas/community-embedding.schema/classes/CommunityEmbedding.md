...
[ai-moodler-backend](../../../../README.md) / [embedding/schemas/community-embedding.schema](../README.md) / CommunityEmbedding

# Class: CommunityEmbedding

Defined in: [src/embedding/schemas/community-embedding.schema.ts:6](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/community-embedding.schema.ts#L6)
...
> **new CommunityEmbedding**(`doc?`): `CommunityEmbedding`
...
Defined in: [src/embedding/schemas/community-embedding.schema.ts:8](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/community-embedding.schema.ts#L8)
...
Defined in: [src/embedding/schemas/community-embedding.schema.ts:11](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/embedding/schemas/community-embedding.schema.ts#L11)
...
> **$assertPopulated**\<`Paths`\>(`path`, `values?`): `Omit`\<`CommunityEmbedding`, keyof `Paths`\> & `Paths`
...
`Omit`\<`CommunityEmbedding`, keyof `Paths`\> & `Paths`
...
> **depopulate**\<`Paths`\>(`path?`): `MergeType`\<`CommunityEmbedding`, `Paths`\>
...
`MergeType`\<`CommunityEmbedding`, `Paths`\>
...
> **getChanges**(): `UpdateQuery`\<`CommunityEmbedding`\>
...
`UpdateQuery`\<`CommunityEmbedding`\>
...
> **populate**\<`Paths`\>(`path`): `Promise`\<`MergeType`\<`CommunityEmbedding`, `Paths`\>\>
...
`Promise`\<`MergeType`\<`CommunityEmbedding`, `Paths`\>\>
...
> **populate**\<`Paths`\>(`path`, `select?`, `model?`, `match?`, `options?`): `Promise`\<`MergeType`\<`CommunityEmbedding`, `Paths`\>\>
...
> **replaceOne**(`replacement?`, `options?`): `Query`\<`any`, `CommunityEmbedding`\>
...
> **save**(`options?`): `Promise`\<`CommunityEmbedding`\>
...
> **updateOne**(`update?`, `options?`): `Query`\<`any`, `CommunityEmbedding`\>
...
`UpdateWithAggregationPipeline` | `UpdateQuery`\<`CommunityEmbedding`\>
