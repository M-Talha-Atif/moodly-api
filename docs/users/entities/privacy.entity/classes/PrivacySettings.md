...
Defined in: [src/users/entities/privacy.entity.ts:7](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/users/entities/privacy.entity.ts#L7)

## Constructors

### Constructor

> **new PrivacySettings**(): `PrivacySettings`
...
> **user**: [`User`](../../user.entity/classes/User.md)
...
Defined in: [src/users/entities/privacy.entity.ts:9](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/users/entities/privacy.entity.ts#L9)
