...
Defined in: [src/users/dto/update-user.dto.ts:5](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/users/dto/update-user.dto.ts#L5)
...
Defined in: [src/users/dto/update-user.dto.ts:10](https://github.com/Progambler227788/AI-Moodler-Backend/blob/9e2761c5a2364787580718d972a0a562e93ec1e3/src/users/dto/update-user.dto.ts#L10)
...
`PartialType(CreateUserDto).name`
...
`PartialType(CreateUserDto).toString`
